...
&lt;http://lodpaddle.univ-nantes.fr/dataSubventions&gt; rdf:type void:Dataset ;
...
<xsl:text>&#009;rdf:type&#009; pdll:dataSubventions;
</xsl:text>
...
<xsl:otherwise><xsl:value-of select="concat(concat('&lt;http://lodpaddle.univ-nantes.fr/dataSubventions/',encode-for-uri(.)),'&gt;')"/>&#009; foaf:name &#009; "<xsl:value-of select="translate(., '&quot;','')"/>"^^xsd:string ;
