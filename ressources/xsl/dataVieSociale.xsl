...
&lt;http://lodpaddle.univ-nantes.fr/dataVieSociale&gt; rdf:type void:Dataset ;
...
<xsl:text>&#009;rdf:type&#009; pdll:dataVieSociale;
</xsl:text>
...
<xsl:otherwise><xsl:value-of select="concat(concat('&lt;http://lodpaddle.univ-nantes.fr/dataVieSociale/',encode-for-uri(.)),'&gt;')"/>&#009; foaf:name &#009; "<xsl:value-of select="translate(., '&quot;','')"/>"^^xsd:string ;
</xsl:otherwise></xsl:choose></xsl:template>
